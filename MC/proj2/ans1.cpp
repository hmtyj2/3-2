...
//    #pragma omp parallel for///////////////////////// (1)->66/(1,2)->100
        for(l=1;l<=lt;l++)
        {
            ...
            nfront = nfront-1;
            nleft = nleft-1;
            #pragma omp parallel for private(vvp2,vvs2,tempux2,tempuy2,tempuz2,tempvx2,tempvy2,tempvz2,tempwx2,tempwy2,tempwz2,tempuxz,tempuxy,tempvyz,tempvxy,tempwxz,tempwyz)////(2)->31
            for(k=ntop;k<nbottom;k++)//////////////////////loop1
            ...
            //#pragma omp parallel for/////////////////// 87s with(2)->37s
            for(k=ntop;k<nbottom;k++)/////////////////// loop 2
                for(j=nfront;j<nback;j++)
                    for(i=nleft;i<nright;i++)
                    {
