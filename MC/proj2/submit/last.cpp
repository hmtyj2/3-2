...
//    #pragma omp parallel for///////////////////////// (1)->66/(1,2)->100
        for(l=1;l<=lt;l++)
        {
            ...
            nfront = nfront-1;
            nleft = nleft-1;
            #pragma omp parallel for shared(c,u,v,w,up,up1,up2,vp,vp1,vp2,wp,wp1,wp2,us,us1,us2,vs,vs1,vs2,ws,ws1,ws2,vss,vpp,dr1,dr2,dtz,dtx,ncx_shot,ncy_shot,ncz_shot,ntop,nleft,nfront,nbottom,nback,nright)
